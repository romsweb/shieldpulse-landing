          ...
          html: `
            <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #0d1117; color: #e0e0e0; border-radius: 8px;">
              ...
              <div style="margin-top: 20px; display: flex; gap: 12px;">
                ...
                <a href="${gscUrl}" style="display: inline-block; padding: 10px 20px; background: #1e2a3a; color: #4A9EFF; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 14px; border: 1px solid #4A9EFF;">Request Indexation (GSC)</a>
              </div>
